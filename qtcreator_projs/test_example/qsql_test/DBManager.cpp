...
DatabaseSettings::DatabaseSettings(
        const DatabaseModeEnum &databastMode, const QString &databaseType, const QString &connectionName)
{
...
DatabaseSettings::DatabaseSettings(
    ...
    : m_databaseMode(DatabaseNameMode)
    , m_databaseType(databaseType)
    , m_connectionName(connectionName)
{
...
DatabaseSettings::DatabaseSettings(const QString &databaseType,
    ...
    : m_databaseMode(DatabaseHostMode)
    , m_databaseType(databaseType)
    , m_connectionName(connectionName)
{

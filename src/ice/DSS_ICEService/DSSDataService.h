...
public:
    ...
    void setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData)
    {
        setReuestResult(resultData, 0);
    }
    void setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData, const ::Ice::Context& __ctx)
    {
        setReuestResult(resultData, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_setReuestResult(resultData, 0, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent));
    }
    ::Ice::AsyncResultPtr
    begin_setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setReuestResult(resultData, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData, const ::Ice::Context& __ctx, const ::IceInternal::Function<void ()>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return begin_setReuestResult(resultData, &__ctx, new ::IceInternal::Cpp11FnOnewayCallbackNC(__response, __exception, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_setReuestResult(resultData, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
#endif

    ::Ice::AsyncResultPtr begin_setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData)
    {
        return begin_setReuestResult(resultData, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData, const ::Ice::Context& __ctx)
    {
        return begin_setReuestResult(resultData, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setReuestResult(resultData, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setReuestResult(resultData, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData, const ::DSSDataService::Callback_DSSServiceCallBack_setReuestResultPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setReuestResult(resultData, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_setReuestResult(const ::TaskDataDef::TaskResultDataPtr& resultData, const ::Ice::Context& __ctx, const ::DSSDataService::Callback_DSSServiceCallBack_setReuestResultPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_setReuestResult(resultData, &__ctx, __del, __cookie);
    }
...
private:
    ...
    void setReuestResult(const ::TaskDataDef::TaskResultDataPtr&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_setReuestResult(const ::TaskDataDef::TaskResultDataPtr&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    ::TaskDataDef::emRequestResultType requestData(const ::TaskDataDef::TaskRequestPtr& request)
    {
        return requestData(request, 0);
    }
    ::TaskDataDef::emRequestResultType requestData(const ::TaskDataDef::TaskRequestPtr& request, const ::Ice::Context& __ctx)
    {
        return requestData(request, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_requestData(const ::TaskDataDef::TaskRequestPtr& request, const ::IceInternal::Function<void (::TaskDataDef::emRequestResultType)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_requestData(request, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_requestData(const ::TaskDataDef::TaskRequestPtr& request, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_requestData(request, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_requestData(const ::TaskDataDef::TaskRequestPtr& request, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (::TaskDataDef::emRequestResultType)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_requestData(request, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_requestData(const ::TaskDataDef::TaskRequestPtr& request, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_requestData(request, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_requestData(const ::TaskDataDef::TaskRequestPtr& request, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (::TaskDataDef::emRequestResultType)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        class Cpp11CB : public ::IceInternal::Cpp11FnCallbackNC
        {
        public:

            Cpp11CB(const ::std::function<void (::TaskDataDef::emRequestResultType)>& responseFunc, const ::std::function<void (const ::Ice::Exception&)>& exceptionFunc, const ::std::function<void (bool)>& sentFunc) :
                ::IceInternal::Cpp11FnCallbackNC(exceptionFunc, sentFunc),
                _response(responseFunc)
            {
                CallbackBase::checkCallback(true, responseFunc || exceptionFunc != nullptr);
        ...
        private:
            ...
            ::std::function<void (::TaskDataDef::emRequestResultType)> _response;
        };
        return begin_requestData(request, __ctx, new Cpp11CB(__response, __exception, __sent));
    }
    
public:
#endif

    ::Ice::AsyncResultPtr begin_requestData(const ::TaskDataDef::TaskRequestPtr& request)
    {
        return begin_requestData(request, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_requestData(const ::TaskDataDef::TaskRequestPtr& request, const ::Ice::Context& __ctx)
    {
        return begin_requestData(request, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_requestData(const ::TaskDataDef::TaskRequestPtr& request, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_requestData(request, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_requestData(const ::TaskDataDef::TaskRequestPtr& request, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_requestData(request, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_requestData(const ::TaskDataDef::TaskRequestPtr& request, const ::DSSDataService::Callback_DSSService_requestDataPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_requestData(request, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_requestData(const ::TaskDataDef::TaskRequestPtr& request, const ::Ice::Context& __ctx, const ::DSSDataService::Callback_DSSService_requestDataPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_requestData(request, &__ctx, __del, __cookie);
    }

    ::TaskDataDef::emRequestResultType end_requestData(const ::Ice::AsyncResultPtr&);
    
private:

    ::TaskDataDef::emRequestResultType requestData(const ::TaskDataDef::TaskRequestPtr&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_requestData(const ::TaskDataDef::TaskRequestPtr&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
...
public:
    ...
    virtual void setReuestResult(const ::TaskDataDef::TaskResultDataPtr&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
public:
    ...
    virtual ::TaskDataDef::emRequestResultType requestData(const ::TaskDataDef::TaskRequestPtr&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
};
...
public:
    ...
    virtual void setReuestResult(const ::TaskDataDef::TaskResultDataPtr&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
...
public:
    ...
    virtual ::TaskDataDef::emRequestResultType requestData(const ::TaskDataDef::TaskRequestPtr&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
};
...
public:
    ...
    virtual void setReuestResult(const ::TaskDataDef::TaskResultDataPtr&, const ::Ice::Current& = ::Ice::Current()) = 0;
...
public:
    ...
    virtual ::TaskDataDef::emRequestResultType requestData(const ::TaskDataDef::TaskRequestPtr&, const ::Ice::Current& = ::Ice::Current()) = 0;
...
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception&);
    typedef void (T::*Sent)(bool);
    typedef void (T::*Response)(::TaskDataDef::emRequestResultType);
...
newCallback_DSSService_requestData(const IceUtil::Handle<T>& instance, void (T::*cb)(::TaskDataDef::emRequestResultType), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_DSSService_requestData<T>(instance, cb, excb, sentcb);
}

template<class T> Callback_DSSService_requestDataPtr
newCallback_DSSService_requestData(T* instance, void (T::*cb)(::TaskDataDef::emRequestResultType), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_DSSService_requestData<T>(instance, cb, excb, sentcb);
}
...
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception& , const CT&);
    typedef void (T::*Sent)(bool , const CT&);
    typedef void (T::*Response)(::TaskDataDef::emRequestResultType, const CT&);
...
newCallback_DSSService_requestData(const IceUtil::Handle<T>& instance, void (T::*cb)(::TaskDataDef::emRequestResultType, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_DSSService_requestData<T, CT>(instance, cb, excb, sentcb);
}

template<class T, typename CT> Callback_DSSService_requestDataPtr
newCallback_DSSService_requestData(T* instance, void (T::*cb)(::TaskDataDef::emRequestResultType, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_DSSService_requestData<T, CT>(instance, cb, excb, sentcb);
}

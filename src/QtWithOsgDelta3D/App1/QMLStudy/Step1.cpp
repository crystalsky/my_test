...
namespace Study_QML
{
	...
	bool CQMLSceneWidget_BaseTest::onButtonClicek( const QString& strFunctionButtonName )
	{
		if (CQMLSceneWidget::onButtonClicek(strFunctionButtonName))
		{
			return true;
		}
...
namespace Study_QML
{
	...
	bool CQMLSceneWidget_Animation::onButtonClicek( const QString& strFunctionButtonName )
	{
		if (CQMLSceneWidget::onButtonClicek(strFunctionButtonName))
		{
			return true;

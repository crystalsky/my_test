...
osg::Node* createScene()
{
	...
	group->addChild(createPoints());
	group->addChild(createLineSrip());
	group->addChild(createLineLoop());
	group->addChild(createPolygon());
	group->addChild(createQUADS());
	group->addChild(createQUAD_STRIP());
	group->addChild(createTRIANGLES());

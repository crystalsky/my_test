...
bool ClientsManager::addClientPrx( const Ice::Identity& id, const DSSDataService::DSSServiceCallBackPrx& prx )
{
	//testid
...
DSSDataService::DSSServiceCallBackPrx ClientsManager::FindClientByID( const std::string& strUserID ) const
{
	MapClients temp;
	{
		IceUtil::Monitor<IceUtil::Mutex>::Lock sync(*this);
	...
	return DSSDataService::DSSServiceCallBackPrx();
}

...
public:
    ...
    bool loginOn(const ::Ice::Identity& id)
    {
        return loginOn(id, 0);
    }
    bool loginOn(const ::Ice::Identity& id, const ::Ice::Context& __ctx)
    {
        return loginOn(id, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_loginOn(const ::Ice::Identity& id, const ::IceInternal::Function<void (bool)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_loginOn(id, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_loginOn(const ::Ice::Identity& id, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_loginOn(id, 0, ::Ice::newCallback(__completed, __sent), 0);
    }
    ::Ice::AsyncResultPtr
    begin_loginOn(const ::Ice::Identity& id, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (bool)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_loginOn(id, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    begin_loginOn(const ::Ice::Identity& id, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __completed, const ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>& __sent = ::IceInternal::Function<void (const ::Ice::AsyncResultPtr&)>())
    {
        return begin_loginOn(id, &__ctx, ::Ice::newCallback(__completed, __sent));
    }
    
private:

    ::Ice::AsyncResultPtr __begin_loginOn(const ::Ice::Identity& id, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (bool)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        ...
        return begin_loginOn(id, __ctx, new Cpp11CB(__response, __exception, __sent));
    }
    
public:
#endif

    ::Ice::AsyncResultPtr begin_loginOn(const ::Ice::Identity& id)
    {
        return begin_loginOn(id, 0, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_loginOn(const ::Ice::Identity& id, const ::Ice::Context& __ctx)
    {
        return begin_loginOn(id, &__ctx, ::IceInternal::__dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_loginOn(const ::Ice::Identity& id, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_loginOn(id, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_loginOn(const ::Ice::Identity& id, const ::Ice::Context& __ctx, const ::Ice::CallbackPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_loginOn(id, &__ctx, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_loginOn(const ::Ice::Identity& id, const ::DSSDataService::Callback_DSSService_loginOnPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_loginOn(id, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_loginOn(const ::Ice::Identity& id, const ::Ice::Context& __ctx, const ::DSSDataService::Callback_DSSService_loginOnPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_loginOn(id, &__ctx, __del, __cookie);
    }
...
private:
    ...
    bool loginOn(const ::Ice::Identity&, const ::Ice::Context*);
    ::Ice::AsyncResultPtr begin_loginOn(const ::Ice::Identity&, const ::Ice::Context*, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& __cookie = 0);
    
public:

    bool loginOff(const ::Ice::Identity& id)
    {
        return loginOff(id, 0);
    }
    bool loginOff(const ::Ice::Identity& id, const ::Ice::Context& __ctx)
    {
        return loginOff(id, &__ctx);
    }
#ifdef ICE_CPP11
    ::Ice::AsyncResultPtr
    begin_loginOff(const ::Ice::Identity& id, const ::IceInternal::Function<void (bool)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_loginOff(id, 0, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
    ...
    ::Ice::AsyncResultPtr
    begin_loginOff(const ::Ice::Identity& id, const ::Ice::Context& __ctx, const ::IceInternal::Function<void (bool)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception = ::IceInternal::Function<void (const ::Ice::Exception&)>(), const ::IceInternal::Function<void (bool)>& __sent = ::IceInternal::Function<void (bool)>())
    {
        return __begin_loginOff(id, &__ctx, __response, __exception, __sent);
    }
    ::Ice::AsyncResultPtr
...
private:
    ...
    ::Ice::AsyncResultPtr __begin_loginOff(const ::Ice::Identity& id, const ::Ice::Context* __ctx, const ::IceInternal::Function<void (bool)>& __response, const ::IceInternal::Function<void (const ::Ice::Exception&)>& __exception, const ::IceInternal::Function<void (bool)>& __sent)
    {
        class Cpp11CB : public ::IceInternal::Cpp11FnCallbackNC
        {
        public:
        ...
        return begin_loginOff(id, __ctx, new Cpp11CB(__response, __exception, __sent));
    }
...
public:
    ...
    ::Ice::AsyncResultPtr begin_loginOff(const ::Ice::Identity& id, const ::DSSDataService::Callback_DSSService_loginOffPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_loginOff(id, 0, __del, __cookie);
    }

    ::Ice::AsyncResultPtr begin_loginOff(const ::Ice::Identity& id, const ::Ice::Context& __ctx, const ::DSSDataService::Callback_DSSService_loginOffPtr& __del, const ::Ice::LocalObjectPtr& __cookie = 0)
    {
        return begin_loginOff(id, &__ctx, __del, __cookie);
    }
...
private:
    ...
    bool loginOff(const ::Ice::Identity&, const ::Ice::Context*);
...
public:
    ...
    virtual bool loginOn(const ::Ice::Identity&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;

    virtual bool loginOff(const ::Ice::Identity&, const ::Ice::Context*, ::IceInternal::InvocationObserver&) = 0;
...
public:
    ...
    virtual bool loginOn(const ::Ice::Identity&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);

    virtual bool loginOff(const ::Ice::Identity&, const ::Ice::Context*, ::IceInternal::InvocationObserver&);
...
public:
    ...
    virtual bool loginOn(const ::Ice::Identity&, const ::Ice::Current& = ::Ice::Current()) = 0;
    ::Ice::DispatchStatus ___loginOn(::IceInternal::Incoming&, const ::Ice::Current&);

    virtual bool loginOff(const ::Ice::Identity&, const ::Ice::Current& = ::Ice::Current()) = 0;

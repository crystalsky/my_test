...
IF(NOT CMAKE_CL_64)
  ...
  SET(_search_release_fedtime_list  libfedtime)
  SET(_search_debug_fedtime_list    libfedtimed)

ELSE()

  SET(dir_suffixes lib/vc100_64)

  SET(_search_release_rti_list      libRTI-NG_64)
  SET(_search_debug_rti_list        libRTI-NGd_64)
  SET(_search_release_fedtime_list  libfedtime_64)
  SET(_search_debug_fedtime_list    libfedtimed_64)
ENDIF()

#MESSAGE(FATAL_ERROR "${dir_suffixes}")
find_library(${THIS_LIB_DEPEND_NAME}_LIBRARY
  ${_search_release_rti_list}

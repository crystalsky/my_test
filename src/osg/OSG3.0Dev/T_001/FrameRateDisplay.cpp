...
bool FrameRateDisplay::handle(const osgGA::GUIEventAdapter& ea, osgGA::GUIActionAdapter& aa)
{
...
void FrameRateDisplay::updateThreadingModelText()
{
...
void FrameRateDisplay::addUserStatsLine(const std::string& label, const osg::Vec4& textColor, const osg::Vec4& barColor,
...
void FrameRateDisplay::removeUserStatsLine(const std::string& label)
{
...
void FrameRateDisplay::setUpHUDCamera(osgViewer::ViewerBase* viewer)
{
...
void FrameRateDisplay::setWindowSize(int width, int height)
{
    if (width <= 0 || height <= 0)
        return;
...
{
    BlockDrawCallback(FrameRateDisplay* statsHandler, float xPos, osg::Stats* viewerStats, osg::Stats* stats, const std::string& beginName, const std::string& endName, int frameDelta, int numFrames):
    ...
    FrameRateDisplay*               _statsHandler;
    float                       _xPos;
...
osg::Geometry* FrameRateDisplay::createBackgroundRectangle(const osg::Vec3& pos, const float width, const float height, osg::Vec4& color)
{
...
osg::Geometry* FrameRateDisplay::createGeometry(const osg::Vec3& pos, float height, const osg::Vec4& colour, unsigned int numBlocks)
{
    osg::Geometry* geometry = new osg::Geometry;
...
{
    FrameMarkerDrawCallback(FrameRateDisplay* statsHandler, float xPos, osg::Stats* viewerStats, int frameDelta, int numFrames):
        _statsHandler(statsHandler),
        _xPos(xPos),
        _viewerStats(viewerStats),
        _frameDelta(frameDelta),
...
osg::Geometry* FrameRateDisplay::createFrameMarkers(const osg::Vec3& pos, float height, const osg::Vec4& colour, unsigned int numBlocks)
{
    osg::Geometry* geometry = new osg::Geometry;
...
osg::Geometry* FrameRateDisplay::createTick(const osg::Vec3& pos, float height, const osg::Vec4& colour, unsigned int numTicks)
{
    osg::Geometry* geometry = new osg::Geometry;
...
void FrameRateDisplay::setUpScene(osgViewer::ViewerBase* viewer)
{
...
void FrameRateDisplay::createTimeStatsLine(const std::string& lineLabel,
...
void FrameRateDisplay::createCameraTimeStats(osg::Vec3& pos, bool acquireGPUStats, osg::Stats* viewerStats, osg::Camera* camera)
{
...
void FrameRateDisplay::getUsage(osg::ApplicationUsage& usage) const
{
